...
?>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
		...
		<span class="field">Name</span><input type="text" name="name" value="<?= $name ?>"><br>
		<span class="field">Username</span><?= $username ?><br>
		<span class="field">Password</span><input type="password" name="password"><br>
		<span class="field">Profile Image</span><img src="<?= $profile_img ?>">
